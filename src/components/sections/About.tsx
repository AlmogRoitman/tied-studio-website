          ...
          >
            <div className="space-y-6">
              <p className="text-lg text-foreground/80 leading-relaxed">
                אנחנו דנה ומישל - שתי חברות שהפכו את התשוקה למיתוג לעסק חלומות. הכל התחיל כשעיצבנו את החתונה של דנה והבנו שיש משהו קסום בשפה עיצובית שמחברת כל פרט באירוע לסיפור אחד גדול. זה הרגע שבו נולד Studio Tied - מתוך האמונה שכל זוג ראוי למיתוג ייחודי שמשקף את האישיות שלו.
              </p>
